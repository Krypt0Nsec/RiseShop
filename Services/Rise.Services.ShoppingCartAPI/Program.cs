...
using Rise.Service.ShoppingCartAPI;

namespace Rise.Services.ShoppingCartAPI
{
	public class Program
	{
		public static void Main(string[] args)
		{
			...
			{
				c.SwaggerDoc("v1", new OpenApiInfo { Title = "Rise.Services.ShoppingCartAPI", Version = "v1" });
				c.EnableAnnotations();
			...
			if (app.Environment.IsDevelopment())
			{
				...
				app.UseSwagger();
				app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "Rise.Services.ShoppingCartAPI v1"));
			}
